...
Execute crypto airdrop / whitelist / quest tasks from websites on the user's behalf. Click-only tasks are automated with the user's public identity; tasks needing X/Twitter connect, wallet signature, or CAPTCHA are escalated to the user with exact steps.
...
cp -r web3/airdrop-execution ~/.hermes/skills/web3/airdrop-execution/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/airdrop-execution-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/airdrop-execution-skill.git ~/.hermes/skills/web3/airdrop-execution/
```
...
```text
skill_view(name="web3/airdrop-execution")
```
...
```text
Use the airdrop execution skill to <describe your specific task here>
```
...
```text
Gunakan skill airdrop execution untuk <deskripsikan tugas spesifik Anda di sini>
```
